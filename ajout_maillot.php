    ...
    <?php endif; ?>
        ...
        <form action="" method="post" enctype="multipart/form-data" class="mt-3">
            <div class="form-group">
                <label for="nom_maillot">Nom du Maillot :</label>
                <input type="text" name="nom_maillot" class="form-control" required value="<?php echo $nomMaillot; ?>">
            </div>
            <div class="form-group">
                <label for="image_maillot">Image du Maillot :</label>
                <input type="file" name="image_maillot" class="form-control-file" accept="image/*" required>
            </div>
